...
def model_simulation(inputs):
	...
	for k in range(interval_tick):
		KPIs, a, b = model_run_schelling_PI_test.step(policy)
		# Note that this is changed for this model as it does not only return the KPIs but also agent numbers
		# todo - change that so it can be generalisable
