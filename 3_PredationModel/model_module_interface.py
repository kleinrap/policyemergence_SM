...
def belief_tree_input():
	...
	len_S_names = ["SheepReproduction", "WolfReproduction", "GrassRegrowth"]  # secondary belief names
	len_PC_names = ["Sheep", "Wolf", "GrownGrass"]  # policy core belief names
...
def policy_instrument_input():
	...
	len_ins = 7  # number of policy instruments considers
	len_ins_names = [0 for f in range(len_ins)]
	len_ins_names[0] = "SR-0.01"
	len_ins_names[1] = "SR+0.01"
	len_ins_names[2] = "WR-0.01"
	len_ins_names[3] = "WR+0.01"
	len_ins_names[4] = "GR-2"
	len_ins_names[5] = "GR+2"
	len_ins_names[6] = "None"
	...
	PF_indices[0] = [0, 1, 2, 3, 4, 5, 6]  # policy family 1
	...
	# 						 SR	  , WR	 , GR
	policy_instruments[0] = [-0.01, None , None]
	policy_instruments[1] = [+0.01, None , None]
	policy_instruments[2] = [None , -0.01, None]
	policy_instruments[3] = [None , +0.01, None]
	policy_instruments[4] = [None , None , -2  ]
	policy_instruments[5] = [None , None , +2  ]
	# the no policy option is always presented to the agents as the last instrument
	policy_instruments[6] = [None, None, None]
