...
# 7. The elecorate influence on policymakers - from 0.01 to 0.10
...
lhs$X2 = 0.7+lhs$X2*0.1

# 3. The affiliation weight 2
lhs$X3 = 0.8+lhs$X3*0.1

# 4. The affiliation weight 3
lhs$X4 = 0.9+lhs$X4*0.1
...
# 7. The affiliation distribution 2
lhs$X7 = 0.01+lhs$X7*0.09
...
write.table(lhs,file="Experiments_LHS.data",sep=",",row.names = FALSE,col.names = FALSE,quote = FALSE)
